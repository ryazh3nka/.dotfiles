...
def set(c, scheme = 'dark', intensity = 'hard'):
    ...
    c.colors.completion.category.border.bottom = t['bg0']
    c.colors.completion.category.border.top = t['bg2']

    c.colors.downloads.bar.bg = t['bg2']
    c.colors.downloads.error.bg = t['red']
    c.colors.downloads.error.fg = t['bg2']
    c.colors.downloads.start.bg = t['blue']
    c.colors.downloads.start.fg = t['fg']
    c.colors.downloads.stop.bg = t['green']
    c.colors.downloads.stop.fg = t['bg2']
